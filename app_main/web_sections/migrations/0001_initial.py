    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_updated_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='web_sections_websection_related', to=settings.AUTH_USER_MODEL, verbose_name='Última actualización por')),
            ],
            options={
