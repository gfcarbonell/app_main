    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_main', models.BooleanField(choices=[(True, 'Yes'), (False, 'Not')], default=False, verbose_name='¿Es Principal?')),
                ...
                ('last_updated_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='web_portals_webportal_related', to=settings.AUTH_USER_MODEL, verbose_name='Última actualización por')),
                ('web_header', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web_headers.WebHeader', verbose_name='Web header')),
                ('web_slider', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web_sliders.WebSlider', verbose_name='Web slider')),
            ],
            options={
