    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_updated_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bar_code_types_barcodetype_related', to=settings.AUTH_USER_MODEL, verbose_name='Última actualización por')),
            ],
            options={
