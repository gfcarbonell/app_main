    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photograph', models.ImageField(blank=True, default='default/No-Avatar-1.png', null=True, upload_to='districts', verbose_name='Fotografía')),
                ...
                ('last_updated_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='districts_district_related', to=settings.AUTH_USER_MODEL, verbose_name='Última actualización por')),
                ('province', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='provinces.Province', verbose_name='Provincia')),
            ],
            options={
                'ordering': ('name',),
                'db_table': 'districts',
